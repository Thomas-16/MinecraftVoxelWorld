...
public class BiomeGenerator : MonoBehaviour
{
    ...
    {
        float terrainHeight = PerlinNoise.OctavePerlin(x,z,biomeNoiseSettings);
        terrainHeight = PerlinNoise.Redistribution(terrainHeight, biomeNoiseSettings);
        int surfaceHeight = PerlinNoise.RemapValue01ToInt(terrainHeight, 0, chunkHeight);
